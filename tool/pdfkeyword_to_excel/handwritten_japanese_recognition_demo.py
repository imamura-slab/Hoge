...
def build_argparser():
    ...
    args.add_argument("-cl", "--charlist", type=str, default="/opt/intel/openvino/deployment_tools/open_model_zoo/demos/python_demos/handwritten_japanese_recognition_demo/data/kondate_nakayosi_char_list.txt", help="Path to the decoding char list file")
